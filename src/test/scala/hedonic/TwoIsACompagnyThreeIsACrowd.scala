...
/**
  ...
  *
  */
object TwoIsACompagnyThreeIsACrowd {

  val player1 = new Player("1")
  val player2 = new Player("2")
  val player3 = new Player("3")

  player1.rlc=new Rlc(Array(Set(Set("1","2")), Set(Set("1","3")), Set(Set("1","2","3")), Set(Set("1"))))
  player2.rlc=new Rlc(Array(Set(Set("2","3")), Set(Set("2","1")), Set(Set("1","2","3")), Set(Set("2"))))
  player3.rlc=new Rlc(Array(Set(Set("3","1")), Set(Set("3","2")), Set(Set("1","2","3")), Set(Set("3"))))
